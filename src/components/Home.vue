<template>
  <el-row class="container">
    ...
    <el-col :span="24" class="topbar-wrap">
      ...
      <div class="topbar-logos" @click="jumpTo('/dashboard')" v-show="!collapsed">
        <a href="#"><img src="/static/icon.jpg"></a>
      </div>
      <div class="topbar-title">
        <span style="font-size: 18px;color: #fff;">微天下后台管理系统</span>
      </div>
      <!-- 测试高德地图 -->
      <div class="topbar-title" style="color: white">
        <div @click="jumpTo('/amap')"><span style="color: rgb(243, 236, 236);font-size: 18px;cursor: pointer">高德地图组件</span></div>
      </div>
