  ...
  <el-row class="wrap">
    <el-col :span="24" class="warp-breadcrum">
      <el-breadcrumb>
        ...
        <el-breadcrumb-item>人员职位管理</el-breadcrumb-item>
      </el-breadcrumb>
    </el-col>
    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-col :span="24" class="wrap-main">
        <el-table :data="rows" style="width: 100%;">
          ...
          <el-table-column prop="postNumber" label="职位编号" min-width="120" sortable>
          </el-table-column>
          <el-table-column prop="postName" label="职位名称" min-width="120" sortable>
          </el-table-column>
          <el-table-column prop="mark" label="备注" min-width="100" sortable>
          </el-table-column>
          <el-table-column prop="createTime" label="创建该信息时间" min-width="160" sortable>
          </el-table-column>
          <el-table-column prop="creators" label="创建者" min-width="160" sortable>
          </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      search: function (val) {
        ...
        API.getWtxPostInfoList(params).then(res => {
          console.log(res)
          if (res.code === 0) {
            console.log(res)
